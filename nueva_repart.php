...
<body>
  ...
  <div class="container mt-3">
    <h2 class="text-center">Agregar Reparticion</h2>
    <div class="row shadow">
      ...
      <div class="col-xl-8 col-lg-6 col-xs-12">
        <div class="alert bg-light text-dark shadow">
          <form method="POST" action="insertar_repart.php">

            <label for="reparticion">Reparticion</label>
            <input name="reparticion" type="text" id="reparticion" placeholder="Reparticíon" maxlength="20" />
            <br>
            <label for="descripcion">Descripción</label>
            <br />
            <textarea name="descripcion" id="descripcion" minlength="10" maxlength="100" rows="5" cols="60"
              placeholder="Descripción de la reparticion"></textarea>
            <br>
            <button type="submit" class="btn btn-dark badge-pill">Guardar</button>
            <button type="reset" class="btn btn-dark badge-pill">Cancelar</button>
