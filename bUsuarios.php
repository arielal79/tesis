  ...
  <body>
    ...
    <div class="container mt-3">
        ...
        <div class="row shadow">
          <div class="col-xl-4 col-lg-6 col-xs-12 shadow">         
            ...
            <div class="dropdown p-3">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="bUsuarios.php">Buscar</a>
              </div>
            </div>
            <div class="dropdown p-3">
              <button
          ...
          <div class="col-xl-8 col-lg-6 col-xs-12">
           ...
           <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input class="form-control" name="apellido" type="text" id="apellido" placeholder="apellido" required> 
              </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                <label for="cod_user">Codigo de Usuario</label>
                <input name="cod_user" type="text" id="cod_user" placeholder="Codigo de usuario" class="form-control" required />
              </div>
              <div class="form-group col-md-4">
                <label for="user_name">Nombre de Usuario</label>
                <input name="user_name" type="text" id="user_name" placeholder="Nombre de usuario" class="form-control" required />
              </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="password" id="clave_conf" name="clave_conf" class="form-control" placeholder="Confirmar Contraseña">
              </div>
            </div>
          ...
          <!--Fin nuevo form-->
          <!--aui deberian aparecer los datos-->
          <div Id="muestra">

          </div>
          <!--fin de aqui deberian aparecer los datos-->
        </div>
      </div>
    </div>
  </div>
