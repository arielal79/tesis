    ...
    <div class="row shadow">
      ...
      <div class="col-xl-8 col-lg-6 col-xs-12">
        <div class="alert bg-light text-dark shadow">
          <form method="POST" action="insertar_rubro.php">

            <label for="rubro">Rubro</label>
            <input type="text" id="rubro" name="rubro" placeholder="Rubro" maxlength="20" />
            <br>
            <label for="descripcion">Descripción</label>
            <br />
            <textarea id="descripcion" name="descripcion" minlength="10" maxlength="100" rows="5" cols="60"
